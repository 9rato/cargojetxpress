				...
				<div class="row align-items-center">
					...
					<div class="col-lg-6 col-md-8">
						<div class="tracking-body">
							<form class="tracking-wrap" action="admin\pages\search.php" method="POST">
								<input type="text" class="input-tracking" placeholder="Type your tracking number" id="trackId" name="trackId">
								
								<button class="default-btn active" type="submit" name="submit">Check Payment</button>
							</form>
						</div>
					</div>
				</div>
